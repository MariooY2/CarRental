  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="hero-section flex h-96 flex-col items-center justify-center font-mono text-white">
        ...
        <p className="mb-2 text-xl lg:text-4xl">The best or nothing.</p>
        <a href="#models" className="mb-3 rounded-full bg-white px-6 py-2 font-medium text-black hover:bg-gray-300 inline-block text-center">
  Explore Models
</a>
      </div>
      ...
      <div className="container mx-auto flex-grow px-4 py-10">
            <h2 className="mb-10 text-center lg:text-5xl text-3xl font-bold">
                Featured Models
            </h2>
            <div id="models" className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {models.map(model => (
                    <ModelItem 
                        key={model.id}
                        name={model.name}
